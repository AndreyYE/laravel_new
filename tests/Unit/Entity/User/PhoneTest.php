...
class PhoneTest extends TestCase
{
    ...
    {
      $user =  factory(User::class)->create(['phone'=>null, 'phone_verified'=>false, 'phone_verify_token'=>null]);
    ...
    {
        /** @var User $user */
        $user =  factory(User::class)->create(['phone'=>'+380976565775', 'phone_verified'=>false, 'phone_verify_token'=>null]);
