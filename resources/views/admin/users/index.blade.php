        ...
        <div class="card-body">
            <form action="?" method="GET">
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select id="status" class="form-control" name="status">
                                ...
                                @foreach ($statuses as $label => $value )
                                    <option value="{{ $value }}"{{ $value === request('status') ? ' selected' : '' }}>{{ $value }}</option>
                                @endforeach;
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-2 text-center align-self-center"><a class="btn btn-success mt-3" href="{{route('admin.users.drop')}}">Drop Filter</a></div>
                </div>
            </form>
        </div>
    </div>
